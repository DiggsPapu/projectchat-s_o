...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 14, -1, -1, sizeof(::chat::UserRegister)},
  { 22, 30, -1, sizeof(::chat::UserInfoRequest)},
  { 32, -1, -1, sizeof(::chat::ChangeStatus)},
  { 40, 51, -1, sizeof(::chat::UserRequest)},
  { 56, 65, -1, sizeof(::chat::UserInfo)},
  { 68, -1, -1, sizeof(::chat::AllConnectedUsers)},
...
const char descriptor_table_protodef_project_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rproject.proto\022\004chat\"i\n\nnewMessage\022\024\n\014m"
  "essage_type\030\001 \001(\010\022\016\n\006sender\030\002 \001(\t\022\026\n\trec"
  "ipient\030\003 \001(\tH\000\210\001\001\022\017\n\007message\030\004 \001(\tB\014\n\n_r"
  "ecipient\",\n\014UserRegister\022\020\n\010username\030\001 \001"
  "(\t\022\n\n\002ip\030\002 \001(\t\"C\n\017UserInfoRequest\022\024\n\014typ"
  "e_request\030\001 \001(\010\022\021\n\004user\030\002 \001(\tH\000\210\001\001B\007\n\005_u"
  "ser\"3\n\014ChangeStatus\022\020\n\010username\030\001 \001(\t\022\021\n"
  "\tnewStatus\030\002 \001(\005\"\374\001\n\013UserRequest\022\016\n\006opti"
  "on\030\001 \001(\005\022(\n\007newUser\030\002 \001(\0132\022.chat.UserReg"
  "isterH\000\210\001\001\022/\n\013infoRequest\030\003 \001(\0132\025.chat.U"
  "serInfoRequestH\001\210\001\001\022\'\n\006status\030\004 \001(\0132\022.ch"
  "at.ChangeStatusH\002\210\001\001\022&\n\007message\030\005 \001(\0132\020."
  "chat.newMessageH\003\210\001\001B\n\n\010_newUserB\016\n\014_inf"
  "oRequestB\t\n\007_statusB\n\n\010_message\"f\n\010UserI"
  "nfo\022\025\n\010username\030\001 \001(\tH\000\210\001\001\022\017\n\002ip\030\002 \001(\tH\001"
  "\210\001\001\022\023\n\006status\030\003 \001(\005H\002\210\001\001B\013\n\t_usernameB\005\n"
  "\003_ipB\t\n\007_status\";\n\021AllConnectedUsers\022&\n\016"
  "connectedUsers\030\001 \003(\0132\016.chat.UserInfo\"\272\002\n"
  "\016ServerResponse\022\016\n\006option\030\001 \001(\005\022\014\n\004code\030"
  "\002 \001(\005\022\025\n\rserverMessage\030\003 \001(\t\0224\n\016connecte"
  "dUsers\030\004 \001(\0132\027.chat.AllConnectedUsersH\000\210"
  "\001\001\022&\n\007message\030\005 \001(\0132\020.chat.newMessageH\001\210"
  "\001\001\022-\n\020userInfoResponse\030\006 \001(\0132\016.chat.User"
  "InfoH\002\210\001\001\022\'\n\006change\030\007 \001(\0132\022.chat.ChangeS"
  "tatusH\003\210\001\001B\021\n\017_connectedUsersB\n\n\010_messag"
  "eB\023\n\021_userInfoResponseB\t\n\007_changeb\006proto"
  "3"
  ;
static ::_pbi::once_flag descriptor_table_project_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_project_2eproto = {
    false, false, 1041, descriptor_table_protodef_project_2eproto,
    "project.proto",
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.newMessage.sender"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.newMessage.recipient"));
        } else
          goto handle_unusual;
        continue;
      // string message = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.newMessage.message"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.UserRegister.username"));
        } else
          goto handle_unusual;
        continue;
      // string ip = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.UserRegister.ip"));
        } else
          goto handle_unusual;
        continue;
      default:
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "chat.UserInfoRequest.user"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* UserInfoRequest::_InternalSerialize(
  ...
  // bool type_request = 1;
  if (this->_internal_type_request() != 0) {
    target = stream->EnsureSpace(target);
...
void UserInfoRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_type_request() != 0) {
    _this->_internal_set_type_request(from._internal_type_request());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void ChangeStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_newstatus() != 0) {
    _this->_internal_set_newstatus(from._internal_newstatus());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
uint8_t* ServerResponse::_InternalSerialize(
  ...
  // string serverMessage = 3;
  if (!this->_internal_servermessage().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
